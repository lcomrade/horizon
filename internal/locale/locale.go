...
var Usage_flag = "Usage: " + build.Name + " [OPTIONS]..."
...
var Version_flag = "Show version and exit"
var Help_flag = "Show help and exit"
...
func getTranslate() {
	if Lang == "ru" {
		...
		Usage_flag = "Использование: " + build.Name + " [ОПЦИИ]..."
